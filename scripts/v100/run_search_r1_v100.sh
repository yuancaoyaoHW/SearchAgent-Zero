#!/usr/bin/env bash
# =============================================================================
# SearchAgent-Zero: Search-R1 Training on 8×V100-32GB
# =============================================================================
# Adapted from run_qwen2.5_3b_instruct_search_multiturn_SearchR1.sh
...
#
# 评测数据集 & 评测计划：
#   数据来源: https://huggingface.co/datasets/RUC-NLPIR/FlashRAG_datasets
#   子集: nq, triviaqa, popqa, hotpotqa, 2wikimultihopqa, musique, bamboogle
#   训练数据: https://huggingface.co/datasets/PeterJinGo/nq_hotpotqa_train
#
#   评测流程:
#     1. 训练中自动验证 (test_freq=50)
#     2. 训练完成后运行 eval 脚本: bash run_qwen2.5_3b_instruct_search_multiturn_SearchR1_eval.sh
#     3. 目标: 平均分 ≥ 0.407 (基线 0.325, 提升 +25.3%)
# =============================================================================
set -x
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-qwen2.5-3b-instruct_searchr1_v100}"
