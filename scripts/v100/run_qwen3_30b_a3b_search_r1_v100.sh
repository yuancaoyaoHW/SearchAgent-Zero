#!/usr/bin/env bash
# =============================================================================
# SearchAgent-Zero: Qwen3-30B-A3B (MoE) Search-R1 Training on 8×V100-32GB
# =============================================================================
# ⚠️ EXPERIMENTAL: Memory budget ~26-30 GB/GPU, may OOM
# If OOM: reduce gpu_memory_utilization to 0.40, reduce n to 2
...
#   - TP=4 for vLLM inference (MoE model needs 4 GPUs)
# =============================================================================
set -x
...
# -----------------------------------------------
# Thinking mode (Qwen3 feature) - disabled for MoE (OOM risk)
# -----------------------------------------------
